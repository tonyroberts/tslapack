...
export function dsyrfs(UPLO: string,
    N: number,
    NRHS: number,
    A: ndarray<number>,
    LDA: number,
    ...
    LDX: number): ndarray<number> {
        ...
        let func = emlapack.cwrap('dsyrfs_', null, [
        ...
        func(pUPLO, pN, pNRHS, pA, pLDA, pAF, pLDAF, pIPIV, pB, pLDB, pX, pLDX, pFERR, pBERR, pWORK, pIWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dsyrfs': " + INFO);
        }
