...
export function dspgv(ITYPE: number,
    JOBZ: string,
    UPLO: string,
    N: number,
    AP: ndarray<number>,
    ...
    LDZ: number): ndarray<number> {
        ...
        let func = emlapack.cwrap('dspgv_', null, [
        ...
        func(pITYPE, pJOBZ, pUPLO, pN, pAP, pBP, pW, pZ, pLDZ, pWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dspgv': " + INFO);
        }
