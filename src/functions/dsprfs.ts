...
export function dsprfs(UPLO: string,
    N: number,
    NRHS: number,
    AP: ndarray<number>,
    AFP: ndarray<number>,
    ...
    LDX: number): ndarray<number> {
        ...
        let func = emlapack.cwrap('dsprfs_', null, [
        ...
        func(pUPLO, pN, pNRHS, pAP, pAFP, pIPIV, pB, pLDB, pX, pLDX, pFERR, pBERR, pWORK, pIWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dsprfs': " + INFO);
        }
