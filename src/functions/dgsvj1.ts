...
export function dgsvj1(JOBV: string,
    M: number,
    N: number,
    N1: number,
    A: ndarray<number>,
    ...
    NSWEEP: number) {
        ...
        let func = emlapack.cwrap('dgsvj1_', null, [
        ...
        func(pJOBV, pM, pN, pN1, pA, pLDA, pD, pSVA, pMV, pV, pLDV, pEPS, pSFMIN, pTOL, pNSWEEP, pWORK, pLWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dgsvj1': " + INFO);
        }
