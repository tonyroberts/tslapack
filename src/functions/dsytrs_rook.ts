...
export function dsytrs_rook(UPLO: string,
    N: number,
    NRHS: number,
    A: ndarray<number>,
    LDA: number,
    ...
    LDB: number) {
        ...
        let func = emlapack.cwrap('dsytrs_rook_', null, [
        ...
        func(pUPLO, pN, pNRHS, pA, pLDA, pIPIV, pB, pLDB, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dsytrs_rook': " + INFO);
        }
}