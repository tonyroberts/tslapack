...
export function dtptrs(UPLO: string,
    TRANS: string,
    DIAG: string,
    N: number,
    NRHS: number,
    ...
    LDB: number) {
        ...
        let func = emlapack.cwrap('dtptrs_', null, [
        ...
        func(pUPLO, pTRANS, pDIAG, pN, pNRHS, pAP, pB, pLDB, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dtptrs': " + INFO);
        }
}