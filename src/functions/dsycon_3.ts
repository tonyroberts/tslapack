...
export function dsycon_3(UPLO: string,
    N: number,
    A: ndarray<number>,
    LDA: number,
    E: ndarray<number>,
    ...
    ANORM: number): number {
        ...
        let func = emlapack.cwrap('dsycon_3_', null, [
        ...
        func(pUPLO, pN, pA, pLDA, pE, pIPIV, pANORM, pRCOND, pWORK, pIWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dsycon_3': " + INFO);
        }
