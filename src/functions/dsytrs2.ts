...
export function dsytrs2(UPLO: string,
    N: number,
    NRHS: number,
    A: ndarray<number>,
    LDA: number,
    ...
    LDB: number) {
        ...
        let func = emlapack.cwrap('dsytrs2_', null, [
        ...
        func(pUPLO, pN, pNRHS, pA, pLDA, pIPIV, pB, pLDB, pWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dsytrs2': " + INFO);
        }
}