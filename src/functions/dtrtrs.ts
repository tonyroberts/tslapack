...
export function dtrtrs(UPLO: string,
    TRANS: string,
    DIAG: string,
    N: number,
    NRHS: number,
    ...
    LDB: number) {
        ...
        let func = emlapack.cwrap('dtrtrs_', null, [
        ...
        func(pUPLO, pTRANS, pDIAG, pN, pNRHS, pA, pLDA, pB, pLDB, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dtrtrs': " + INFO);
        }
}