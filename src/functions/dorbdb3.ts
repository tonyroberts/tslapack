...
export function dorbdb3(M: number,
    P: number,
    Q: number,
    X11: ndarray<number>,
    LDX11: number,
    ...
    LDX21: number): ndarray<number> {
        ...
        let func = emlapack.cwrap('dorbdb3_', null, [
            'number', // [in] M: INTEGER
            'number', // [in] P: INTEGER
            'number', // [in] Q: INTEGER
        ...
        func(pM, pP, pQ, pX11, pLDX11, pX21, pLDX21, pTHETA, pPHI, pTAUP1, pTAUP2, pTAUQ1, pWORK, pLWORK, pINFO);
        INFO = emlapack.getValue(pINFO, 'i32');
        if (INFO != 0) {
            throw new Error("Error calling 'dorbdb3': " + INFO);
        }
