...
export function dgtts2(ITRANS: number,
    N: number,
    NRHS: number,
    DL: ndarray<number>,
    D: ndarray<number>,
    ...
    LDB: number) {
        ...
        let func = emlapack.cwrap('dgtts2_', null, [
            'number', // [in] ITRANS: INTEGER
            'number', // [in] N: INTEGER
        ...
        let pITRANS = emlapack._malloc(4);
        let pN = emlapack._malloc(4);
        let pNRHS = emlapack._malloc(4);
        let pLDB = emlapack._malloc(4);

        emlapack.setValue(pITRANS, ITRANS, 'i32');
        ...
        func(pITRANS, pN, pNRHS, pDL, pD, pDU, pDU2, pIPIV, pB, pLDB);
}